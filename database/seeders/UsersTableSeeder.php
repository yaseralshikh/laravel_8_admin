...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $displayPost = Permission::create([ 'name' => 'display_pages', 'display_name' => 'Show Pages', 'route' => 'pages/{pages}', 'module' => 'posts', 'as' => 'pages.show', 'icon' => null, 'parent' => $managePages->id, 'parent_show' => $managePages->id, 'parent_original' => $managePages->id, 'appear' => '0', 'ordering' => '0', ]);
